...
public class RoomServer extends JFrame implements ActionListener {

     private JButton close;
     public JTextArea user;
     private ServerSocket server;
     public Hashtable<String, RoomClientConnect> listUser;
     ...
     private void go() {
	  try {
	       listUser = new Hashtable<String, RoomClientConnect>();
	       server = new ServerSocket(2207);
	       user.append("Máy chủ bắt đầu phục vụ\n");
	       while (true) {
		    Socket client = server.accept();
		    new RoomClientConnect(this, client);
	       }
	  } catch (IOException e) {
